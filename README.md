# Week 05 - Tydituesday commentary assignment
...
The data for [this week](https://github.com/rfordatascience/tidytuesday/tree/master/data/2020/2020-10-13) (Week 42, based on the weeks of the year) deals with the **Datasaurus Dozen** dataset, which is a great dataset which exemplifies the need for proper data visualization (vs just summary statistics or traditional bar/boxplot figures) for the complete understanding of your data.

This dataset reminds me of a recent [tweet](https://twitter.com/ChenxinLi2/status/1310101956883435523) dealing with a simmilar issue. Remember, *friends dont let friends make ar plots*
